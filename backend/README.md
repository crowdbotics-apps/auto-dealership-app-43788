...
## Project Structure
    ...
    ├── auto_dealership_app_43788  # Django project configurations
...
1. Clone this repo and `cd auto_dealership_app_43788`
...
2. Clone this repo and `cd auto_dealership_app_43788`
